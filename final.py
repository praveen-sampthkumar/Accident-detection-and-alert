...
while True:
  ...
  cv2.imwrite("D:\python output\ivts code\Accident-detection-Project--master\code\ouput\shot.jpg",p)
  
  #From Python Image Library(PIL) import Image class
  from PIL import Image
  
  #Open image from the directories and returns it's histogram's
  h1 = Image.open("D:\python output\ivts code\Accident-detection-Project--master\code\image1.jpg").histogram()
  h2 = Image.open("D:\python output\ivts code\Accident-detection-Project--master\code\ouput\shot.jpg").histogram()
  j=j+1
  ...
  #Then there is a similarity between images. i.e., Scene similar to an accident is found
    print ("accident accident accident accident accident")
